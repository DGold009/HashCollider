...
- accepting responsibility for our mistakes, apologizing to those affected and learning
  from the experience;
- focusing on what is best for the overall community, not just ourselves;
- helping newcomers - this is an educational project and every question is welcome.
...
- using the project or its community to plan or promote attacks on systems without
  authorization;
...
project maintainers through the repository's private reporting mechanism. All complaints
will be reviewed and investigated promptly and fairly. Maintainers are obligated to respect
the privacy and security of the reporter of any incident.

## Enforcement guidelines

1. **Correction** - for inappropriate language or other unprofessional behavior: a private,
   written warning with clarity about the nature of the violation. A public apology may be
   requested.
2. **Warning** - for a single incident or series of actions: a warning with consequences
   for continued behavior, including no interaction with the people involved for a
   specified period.
3. **Temporary ban** - for a serious violation or sustained inappropriate behavior: a
   temporary ban from any interaction or public communication with the community.
4. **Permanent ban** - for a pattern of violations, harassment of an individual, or
   aggression toward or disparagement of classes of individuals: a permanent ban from any
